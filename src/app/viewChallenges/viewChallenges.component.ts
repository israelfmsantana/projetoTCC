...
@Component({
    selector: 'app-viewChallenges',
    templateUrl: './viewChallenges.component.html',
    styleUrl: './viewChallenges.component.css'
})
export class viewChallengesComponent implements OnInit {
    ...
    ngOnInit(): void {
        localStorage.setItem('lastRoute', '/viewChallenges');
