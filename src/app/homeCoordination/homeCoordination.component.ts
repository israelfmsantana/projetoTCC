...
@Component({
  selector: 'app-homeCoordination',
  templateUrl: './homeCoordination.component.html',
  styleUrls: ['./homeCoordination.component.css'],
  encapsulation: ViewEncapsulation.None // Desativa o encapsulamento de estilos
})
export class HomeCoordinationComponent implements OnInit {
  constructor( private router: Router, private darkModeService: DarkModeService) {}

  ngOnInit(): void {
    localStorage.setItem('lastRoute', '/homeCoordination');
  }
